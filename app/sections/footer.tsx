      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-2">
          <p className="text-gray-400 text-sm">
            <Link href="https://www.chess.com/member/rinatdem" target="_blank" className="text-gradient font-semibold">2000</Link> peak rating on
            chess.com(top 0.3%)
          </p>
          <p className="text-gray-400 text-sm">
            Speaking <span className="text-gradient font-semibold">4</span>{" "}
            languages(Ukr, Rus, Eng, Slov)
          </p>
          <p className="text-gray-400 text-sm">
            Making an{" "}
            <Link
          ...
          <p className="text-gray-400 text-sm">
            Graduating from high school with a <span className="text-gradient font-semibold">10.8/12</span>(Analogue to US{" "}
